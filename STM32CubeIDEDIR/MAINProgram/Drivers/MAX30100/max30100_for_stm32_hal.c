...
#define MAX30100_HR_DATA_H 0x02 // Example address for high byte of heart rate data
#define MAX30100_HR_DATA_L 0x03 // Example address for low byte of heart rate data

// Declare the variables
uint16_t _max30100_hr_sample;
...
uint16_t _max30100_time_sample[16];
...
{
    static uint8_t sample_index = 0;  // Circular buffer index
    char uart_buffer[50];
